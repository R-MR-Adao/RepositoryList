...
time.sleep(1)
print('')
type_write(line_break(' All you need to do is contact me through email:'))
type_write(line_break(colored(' rm.ribeiro.adao@gmail.com', 'green')))
type_write(line_break(' Or LinkedIn:'))
